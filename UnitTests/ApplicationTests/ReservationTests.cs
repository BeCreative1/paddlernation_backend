...
public class ReservationTests : DbTestBaseClass
{
    ...
    public async Task CreateAsync_EmptyPaddleBoards()
    {
        ...
        var created =
            await Assert.ThrowsExceptionAsync<Exception>(
                async () => await _logic.CreateReservationAsync(reservationDto));
    ...
    public async Task GetAsync_ReturnsReservations()
    {
        ...
        var reservation1 = new ReservationCreationDto
            {DateFrom = expectedDates[0], DateTo = expectedDates[0].AddDays(1), PaddleBoardIds = paddleBoards};
        var reservation2 = new ReservationCreationDto
            {DateFrom = expectedDates[1], DateTo = expectedDates[1].AddDays(1), PaddleBoardIds = paddleBoards};
